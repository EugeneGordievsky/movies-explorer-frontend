...
export default function MobileNav(props) {
  ...
  return (
    <section className={`mobile-nav ${ props.isMobileNav && `mobile-nav_visible` }`}>
      <div className='mobile-nav__container'>
        ...
        <nav className='mobile-nav__nav-block'>
          <ul className='mobile-nav__links' >
            ...
            <li className='mobile-nav__list-element'>
              <Link to='./profile' className={`mobile-nav__link mobile-nav__link_profile ${ location === '/profile' && `mobile-nav__link_active` }`} onClick={() => {
                props.setMobileNav(false)
              }} >Аккаунт
